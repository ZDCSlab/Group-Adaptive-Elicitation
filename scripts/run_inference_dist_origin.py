...
if __name__ == "__main__":
    ...
    if args.MIG:
        save_path = f'./results_tuning_noisy50/results_{mode}/{year}_{mode}_node_select_{node_select}_MIG_T{T}_{x_heldout}_{args.imputation}.jsonl'

    else:
        save_path = f'./results_tuning_noisy50/results_{mode}/{year}_{mode}_node_select_{node_select}_N{args.N}_percent{selected_respodent}_T{T}_{x_heldout}_{args.imputation}_top_k_nei{args.top_k_nei}.jsonl'

...
def load_ces_dataset_partition(year, split='train'):
    out_dir = Path(f'/home/ruomeng/gae/dataset/ces_promax/processed')
    ...
    jsonl_file = f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/neighbors_{year}.jsonl"  
    neighbors_info = load_jsonl_as_dict_of_dict(jsonl_file, key='caseid')
    
    df_survey = pd.read_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/questions_{split}_{year}.csv")
...
if __name__ == "__main__":
    ...
    for include_neighbor in [True, False]:
        ...
        for year in ['24']:
            ...
            save_dir = Path("/home/ruomeng/gae/dataset/ces_promax/processed")

...
def load_ces_dataset_partition(year, split='train'):
    out_dir = Path(f'/home/ruomeng/gae/dataset/ces_pro/processed')
    ...
    df_survey = pd.read_csv(f"/home/ruomeng/gae/dataset/ces_pro/raw/{year}/questions_{split}_{year}.csv")
...
if __name__ == "__main__":
    ...
    for year in ['20', '22', '24']:
        ...
        save_dir = Path("/home/ruomeng/gae/dataset/ces_pro/processed")

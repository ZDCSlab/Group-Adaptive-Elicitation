...
def load_ces_dataset_partition(year, train_ids, test_ids):
    out_dir = Path(f'/home/ruomeng/gae/dataset/ces_golden/processed')
    out_dir.mkdir(parents=True, exist_ok=True)  

    out_path_train = Path(f'/home/ruomeng/gae/dataset/ces_golden/processed/ces_{year}_train.jsonl')
    out_path_test = Path(f'/home/ruomeng/gae/dataset/ces_golden/processed/ces_{year}_test.jsonl')
    ...
    jsonl_file = f"/home/ruomeng/gae/dataset/ces_golden/raw/{year}/neighbors_{year}.jsonl"  
    ...
    df_survey = pd.read_csv(f"/home/ruomeng/gae/dataset/ces_golden/raw/{year}/questions_{year}.csv")
    ...
    for respondent in tqdm(caseid_lst, total=len(caseid_lst), desc="Building dataset", dynamic_ncols=True):
        ...
        if respondent in train_ids:
            # print('train_ids')
            dataset_train.append({'case_id': respondent, 'survey': respondent_designs})
        else:
            # print('test_ids')
            dataset_test.append({'case_id': respondent, 'survey': respondent_designs})
        # input()
...
def _pack_entity(entity, q_key="question", a_key="answer",
    ...
    for it in items:
        ...
        if include_neighbor:
            ...
            parts.append(f"{Q}{q}{N}{A}{a_str}{EOS}")
...
if __name__ == "__main__":
    ...
    for split in ['20-22', '22-24', '20-24']:
        ...
        save_dir = Path("/home/ruomeng/gae/dataset/ces_golden/processed")

...
if __name__ == "__main__":
    ...
    for year in ['20', '22', '24']:
        ...
        jsonl_file = f"/home/ruomeng/gae/dataset/ces_promaxmax/question_codebook.jsonl"  
        ...
        for caseid in codebook.keys():
            if codebook[caseid]["options"] == target:
                ...
                graph_qs.append(caseid)

        train_qs, holdout_qs = split_questions(question_set, train_ratio=0.667, seed=42)
        ...
        # Save to CSV
        graph_df.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/graph_qs.csv", index=False)
        train_df.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/train_qs.csv", index=False)
        holdout_df.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/holdout_qs.csv", index=False)
        ...
        communities, stats = cluster_communities_size_constrained(
            ...
            min_size=30, max_size=100,   # your bounds
        ...
        save_cluster_jsonl_with_ordered_neighbors_wide(
            ...
            f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/neighbors_{year}.jsonl",
            id_col="caseid",
            comm_col="community",
            include_self=False,      # typical
            neighbor_limit=20      # or set an int cap if needed
        )

        intra_summary, centroid_sim = community_similarity_report(survey_data_filtered, communities, id_col="caseid")
        intra_summary.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/intra_summary_graph.csv", index=False)
        draw_centroid_sim(centroid_sim, topk=30, title="Centroid Sim (Top 30)", save_path = f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/centroid_sim_graph.png")
        ...
        intra_summary.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/intra_summary_train.csv", index=False)
        draw_centroid_sim(centroid_sim, topk=30, title="Centroid Sim (Top 30)", save_path = f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/centroid_sim_train.png")
        ...
        intra_summary.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/intra_summary_holdout.csv", index=False)
        draw_centroid_sim(centroid_sim, topk=30, title="Centroid Sim (Top 30)", save_path = f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/centroid_sim_holdout.png")
        ...
        for split in ['train', 'val', 'test']:
            ...
            survey_data_filtered_seen.to_csv(f"/home/ruomeng/gae/dataset/ces_promaxmax/raw/{year}/questions_{split}_{year}.csv", index=False)

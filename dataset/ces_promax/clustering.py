...
if __name__ == "__main__":
    ...
    for year in ['20', '22', '24']:
        ...
        jsonl_file = f"/home/ruomeng/gae/dataset/ces_promax/question_codebook.jsonl"  
        ...
        # Save to CSV
        graph_df.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/graph_qs.csv", index=False)
        train_df.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/train_qs.csv", index=False)
        holdout_df.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/holdout_qs.csv", index=False)
        ...
        save_cluster_jsonl_with_ordered_neighbors_wide(
            ...
            f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/neighbors_{year}.jsonl",
            id_col="caseid",
            comm_col="community",
        ...
        intra_summary.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/intra_summary_graph.csv", index=False)
        draw_centroid_sim(centroid_sim, topk=30, title="Centroid Sim (Top 30)", save_path = f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/centroid_sim_graph.png")
        ...
        intra_summary.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/intra_summary_train.csv", index=False)
        draw_centroid_sim(centroid_sim, topk=30, title="Centroid Sim (Top 30)", save_path = f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/centroid_sim_train.png")
        ...
        intra_summary.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/intra_summary_holdout.csv", index=False)
        draw_centroid_sim(centroid_sim, topk=30, title="Centroid Sim (Top 30)", save_path = f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/centroid_sim_holdout.png")
        ...
        for split in ['train', 'val', 'test']:
            ...
            survey_data_filtered_seen.to_csv(f"/home/ruomeng/gae/dataset/ces_promax/raw/{year}/questions_{split}_{year}.csv", index=False)
